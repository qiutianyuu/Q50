...
class RexKingETH92Strategy:
    ...
    def calculate_indicators(self, df):
        """计算技术指标 - 9.2优化"""
        print("Calculating indicators for RexKing ETH 9.2...")
    ...
    def mock_etherscan_data(self, df):
        """模拟Etherscan数据 - 9.2修复time_window"""
    ...
    def backtest(self, df):
        """回测策略 - 9.2修复TP/SL逻辑"""
        print("Starting RexKing ETH 9.2 backtest...")
    ...
    def diagnostics(self, df):
        """诊断各过滤器的通过率"""
        print("\n" + "="*50)
        print("REXKING ETH 9.2 DIAGNOSTICS")
        print("="*50)
    ...
    def analyze_results(self):
        ...
        print("\n" + "="*60)
        print("RexKing ETH 9.2 Strategy Results")
        print("="*60)
...
def main():
    # 初始化策略
    strategy = RexKingETH92Strategy(capital=10000)
    ...
    if trades_df is not None and len(trades_df) > 0:
        trades_df.to_csv('rexking_eth_9_2_trades_2025_04.csv', index=False)
        print(f"\nTrades saved to rexking_eth_9_2_trades_2025_04.csv")
